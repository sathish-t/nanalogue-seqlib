...
#define sk_SCT_new(cmp) ((STACK_OF(SCT) *)OPENSSL_sk_new_reserve_ex(ossl_check_SCT_compfunc_type(cmp), 0, sk_SCT_compfunc_thunk))
#define sk_SCT_new_null() ((STACK_OF(SCT) *)OPENSSL_sk_new_null())
#define sk_SCT_new_reserve(cmp, n) ((STACK_OF(SCT) *)OPENSSL_sk_new_reserve_ex(ossl_check_SCT_compfunc_type(cmp), (n), sk_SCT_compfunc_thunk))
...
#define sk_SCT_pop_free(sk, freefunc) OPENSSL_sk_pop_free_ex(ossl_check_SCT_sk_type(sk), ossl_check_SCT_freefunc_type(freefunc), sk_SCT_freefunc_thunk)
...
#define sk_SCT_deep_copy(sk, copyfunc, freefunc) ((STACK_OF(SCT) *)OPENSSL_sk_deep_copy_ex(ossl_check_const_SCT_sk_type(sk), ossl_check_SCT_copyfunc_type(copyfunc), ossl_check_SCT_freefunc_type(freefunc), sk_SCT_copyfunc_thunk, sk_SCT_freefunc_thunk))
#define sk_SCT_set_cmp_func(sk, cmp) ((sk_SCT_compfunc)OPENSSL_sk_set_cmp_func_ex(ossl_check_SCT_sk_type(sk), ossl_check_SCT_compfunc_type(cmp), sk_SCT_compfunc_thunk))
...
#define sk_CTLOG_new(cmp) ((STACK_OF(CTLOG) *)OPENSSL_sk_new_reserve_ex(ossl_check_CTLOG_compfunc_type(cmp), 0, sk_CTLOG_compfunc_thunk))
#define sk_CTLOG_new_null() ((STACK_OF(CTLOG) *)OPENSSL_sk_new_null())
#define sk_CTLOG_new_reserve(cmp, n) ((STACK_OF(CTLOG) *)OPENSSL_sk_new_reserve_ex(ossl_check_CTLOG_compfunc_type(cmp), (n), sk_CTLOG_compfunc_thunk))
...
#define sk_CTLOG_pop_free(sk, freefunc) OPENSSL_sk_pop_free_ex(ossl_check_CTLOG_sk_type(sk), ossl_check_CTLOG_freefunc_type(freefunc), sk_CTLOG_freefunc_thunk)
...
#define sk_CTLOG_deep_copy(sk, copyfunc, freefunc) ((STACK_OF(CTLOG) *)OPENSSL_sk_deep_copy_ex(ossl_check_const_CTLOG_sk_type(sk), ossl_check_CTLOG_copyfunc_type(copyfunc), ossl_check_CTLOG_freefunc_type(freefunc), sk_CTLOG_copyfunc_thunk, sk_CTLOG_freefunc_thunk))
#define sk_CTLOG_set_cmp_func(sk, cmp) ((sk_CTLOG_compfunc)OPENSSL_sk_set_cmp_func_ex(ossl_check_CTLOG_sk_type(sk), ossl_check_CTLOG_compfunc_type(cmp), sk_CTLOG_compfunc_thunk))
