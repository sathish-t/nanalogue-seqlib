...
#define SKM_DEFINE_STACK_OF_ADAPTERS(t1, t2, t3)                                                                \
    STACK_OF(t1);                                                                                               \
    typedef int (*sk_##t1##_compfunc)(const t3 *const *a, const t3 *const *b);                                  \
    typedef void (*sk_##t1##_freefunc)(t3 * a);                                                                 \
    typedef t3 *(*sk_##t1##_copyfunc)(const t3 *a);                                                             \
    static ossl_inline int sk_##t1##_compfunc_thunk(OPENSSL_sk_compfunc cmp, const void *pa, const void *pb) \
    {                                                                                                     \
        const t3 *a = (const t3 *)*(const void *const *)pa;                                                  \
        const t3 *b = (const t3 *)*(const void *const *)pb;                                                  \
        return ((sk_##t1##_compfunc)cmp)(&a, &b);                                                           \
    }                                                                                                     \
    static ossl_inline void *sk_##t1##_copyfunc_thunk(OPENSSL_sk_copyfunc copy, const void *ptr)              \
    {                                                                                                     \
        return ((sk_##t1##_copyfunc)copy)((const t3 *)ptr);                                                  \
    }                                                                                                     \
...
#define SKM_DEFINE_STACK_OF_INTERNAL(t1, t2, t3) \
    SKM_DEFINE_STACK_OF_ADAPTERS(t1, t2, t3) \
...
#define SKM_DEFINE_STACK_OF(t1, t2, t3)                                                                                    \
    ...
    {                                                                                                                      \
        return (STACK_OF(t1) *)OPENSSL_sk_new_reserve_ex((OPENSSL_sk_compfunc)compare, 0, sk_##t1##_compfunc_thunk);         \
    }                                                                                                                      \
    ...
    {                                                                                                                      \
        return (STACK_OF(t1) *)OPENSSL_sk_new_reserve_ex((OPENSSL_sk_compfunc)compare, n, sk_##t1##_compfunc_thunk);         \
    }                                                                                                                      \
    ...
    {                                                                                                                      \
        OPENSSL_sk_pop_free_ex((OPENSSL_STACK *)sk, (OPENSSL_sk_freefunc)freefunc, sk_##t1##_freefunc_thunk);               \
    }                                                                                                                      \
    ...
    {                                                                                                                      \
        return (STACK_OF(t1) *)OPENSSL_sk_deep_copy_ex((const OPENSSL_STACK *)sk,                                          \
            (OPENSSL_sk_copyfunc)copyfunc,                                                                                 \
            (OPENSSL_sk_freefunc)freefunc, sk_##t1##_copyfunc_thunk, sk_##t1##_freefunc_thunk);                              \
    }                                                                                                                      \
    static ossl_unused ossl_inline sk_##t1##_compfunc sk_##t1##_set_cmp_func(STACK_OF(t1) *sk, sk_##t1##_compfunc compare) \
    {                                                                                                                      \
        return (sk_##t1##_compfunc)OPENSSL_sk_set_cmp_func_ex((OPENSSL_STACK *)sk, (OPENSSL_sk_compfunc)compare, sk_##t1##_compfunc_thunk); \
    }
...
#define sk_OPENSSL_STRING_new(cmp) ((STACK_OF(OPENSSL_STRING) *)OPENSSL_sk_new_reserve_ex(ossl_check_OPENSSL_STRING_compfunc_type(cmp), 0, sk_OPENSSL_STRING_compfunc_thunk))
#define sk_OPENSSL_STRING_new_null() ((STACK_OF(OPENSSL_STRING) *)OPENSSL_sk_new_null())
#define sk_OPENSSL_STRING_new_reserve(cmp, n) ((STACK_OF(OPENSSL_STRING) *)OPENSSL_sk_new_reserve_ex(ossl_check_OPENSSL_STRING_compfunc_type(cmp), (n), sk_OPENSSL_STRING_compfunc_thunk))
...
#define sk_OPENSSL_STRING_pop_free(sk, freefunc) OPENSSL_sk_pop_free_ex(ossl_check_OPENSSL_STRING_sk_type(sk), ossl_check_OPENSSL_STRING_freefunc_type(freefunc), sk_OPENSSL_STRING_freefunc_thunk)
...
#define sk_OPENSSL_STRING_deep_copy(sk, copyfunc, freefunc) ((STACK_OF(OPENSSL_STRING) *)OPENSSL_sk_deep_copy_ex(ossl_check_const_OPENSSL_STRING_sk_type(sk), ossl_check_OPENSSL_STRING_copyfunc_type(copyfunc), ossl_check_OPENSSL_STRING_freefunc_type(freefunc), sk_OPENSSL_STRING_copyfunc_thunk, sk_OPENSSL_STRING_freefunc_thunk))
#define sk_OPENSSL_STRING_set_cmp_func(sk, cmp) ((sk_OPENSSL_STRING_compfunc)OPENSSL_sk_set_cmp_func_ex(ossl_check_OPENSSL_STRING_sk_type(sk), ossl_check_OPENSSL_STRING_compfunc_type(cmp), sk_OPENSSL_STRING_compfunc_thunk))
...
#define sk_OPENSSL_CSTRING_new(cmp) ((STACK_OF(OPENSSL_CSTRING) *)OPENSSL_sk_new_reserve_ex(ossl_check_OPENSSL_CSTRING_compfunc_type(cmp), 0, sk_OPENSSL_CSTRING_compfunc_thunk))
#define sk_OPENSSL_CSTRING_new_null() ((STACK_OF(OPENSSL_CSTRING) *)OPENSSL_sk_new_null())
#define sk_OPENSSL_CSTRING_new_reserve(cmp, n) ((STACK_OF(OPENSSL_CSTRING) *)OPENSSL_sk_new_reserve_ex(ossl_check_OPENSSL_CSTRING_compfunc_type(cmp), (n), sk_OPENSSL_CSTRING_compfunc_thunk))
...
#define sk_OPENSSL_CSTRING_pop_free(sk, freefunc) OPENSSL_sk_pop_free_ex(ossl_check_OPENSSL_CSTRING_sk_type(sk), ossl_check_OPENSSL_CSTRING_freefunc_type(freefunc), sk_OPENSSL_CSTRING_freefunc_thunk)
...
#define sk_OPENSSL_CSTRING_deep_copy(sk, copyfunc, freefunc) ((STACK_OF(OPENSSL_CSTRING) *)OPENSSL_sk_deep_copy_ex(ossl_check_const_OPENSSL_CSTRING_sk_type(sk), ossl_check_OPENSSL_CSTRING_copyfunc_type(copyfunc), ossl_check_OPENSSL_CSTRING_freefunc_type(freefunc), sk_OPENSSL_CSTRING_copyfunc_thunk, sk_OPENSSL_CSTRING_freefunc_thunk))
#define sk_OPENSSL_CSTRING_set_cmp_func(sk, cmp) ((sk_OPENSSL_CSTRING_compfunc)OPENSSL_sk_set_cmp_func_ex(ossl_check_OPENSSL_CSTRING_sk_type(sk), ossl_check_OPENSSL_CSTRING_compfunc_type(cmp), sk_OPENSSL_CSTRING_compfunc_thunk))
...
#define sk_OPENSSL_BLOCK_new(cmp) ((STACK_OF(OPENSSL_BLOCK) *)OPENSSL_sk_new_reserve_ex(ossl_check_OPENSSL_BLOCK_compfunc_type(cmp), 0, sk_OPENSSL_BLOCK_compfunc_thunk))
#define sk_OPENSSL_BLOCK_new_null() ((STACK_OF(OPENSSL_BLOCK) *)OPENSSL_sk_new_null())
#define sk_OPENSSL_BLOCK_new_reserve(cmp, n) ((STACK_OF(OPENSSL_BLOCK) *)OPENSSL_sk_new_reserve_ex(ossl_check_OPENSSL_BLOCK_compfunc_type(cmp), (n), sk_OPENSSL_BLOCK_compfunc_thunk))
...
#define sk_OPENSSL_BLOCK_pop_free(sk, freefunc) OPENSSL_sk_pop_free_ex(ossl_check_OPENSSL_BLOCK_sk_type(sk), ossl_check_OPENSSL_BLOCK_freefunc_type(freefunc), sk_OPENSSL_BLOCK_freefunc_thunk)
...
#define sk_OPENSSL_BLOCK_deep_copy(sk, copyfunc, freefunc) ((STACK_OF(OPENSSL_BLOCK) *)OPENSSL_sk_deep_copy_ex(ossl_check_const_OPENSSL_BLOCK_sk_type(sk), ossl_check_OPENSSL_BLOCK_copyfunc_type(copyfunc), ossl_check_OPENSSL_BLOCK_freefunc_type(freefunc), sk_OPENSSL_BLOCK_copyfunc_thunk, sk_OPENSSL_BLOCK_freefunc_thunk))
#define sk_OPENSSL_BLOCK_set_cmp_func(sk, cmp) ((sk_OPENSSL_BLOCK_compfunc)OPENSSL_sk_set_cmp_func_ex(ossl_check_OPENSSL_BLOCK_sk_type(sk), ossl_check_OPENSSL_BLOCK_compfunc_type(cmp), sk_OPENSSL_BLOCK_compfunc_thunk))
