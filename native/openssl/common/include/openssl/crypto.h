...
#define sk_void_new(cmp) ((STACK_OF(void) *)OPENSSL_sk_new_reserve_ex(ossl_check_void_compfunc_type(cmp), 0, sk_void_compfunc_thunk))
#define sk_void_new_null() ((STACK_OF(void) *)OPENSSL_sk_new_null())
#define sk_void_new_reserve(cmp, n) ((STACK_OF(void) *)OPENSSL_sk_new_reserve_ex(ossl_check_void_compfunc_type(cmp), (n), sk_void_compfunc_thunk))
...
#define sk_void_pop_free(sk, freefunc) OPENSSL_sk_pop_free_ex(ossl_check_void_sk_type(sk), ossl_check_void_freefunc_type(freefunc), sk_void_freefunc_thunk)
...
#define sk_void_deep_copy(sk, copyfunc, freefunc) ((STACK_OF(void) *)OPENSSL_sk_deep_copy_ex(ossl_check_const_void_sk_type(sk), ossl_check_void_copyfunc_type(copyfunc), ossl_check_void_freefunc_type(freefunc), sk_void_copyfunc_thunk, sk_void_freefunc_thunk))
#define sk_void_set_cmp_func(sk, cmp) ((sk_void_compfunc)OPENSSL_sk_set_cmp_func_ex(ossl_check_void_sk_type(sk), ossl_check_void_compfunc_type(cmp), sk_void_compfunc_thunk))
