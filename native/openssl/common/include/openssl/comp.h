...
#define sk_SSL_COMP_new(cmp) ((STACK_OF(SSL_COMP) *)OPENSSL_sk_new_reserve_ex(ossl_check_SSL_COMP_compfunc_type(cmp), 0, sk_SSL_COMP_compfunc_thunk))
#define sk_SSL_COMP_new_null() ((STACK_OF(SSL_COMP) *)OPENSSL_sk_new_null())
#define sk_SSL_COMP_new_reserve(cmp, n) ((STACK_OF(SSL_COMP) *)OPENSSL_sk_new_reserve_ex(ossl_check_SSL_COMP_compfunc_type(cmp), (n), sk_SSL_COMP_compfunc_thunk))
...
#define sk_SSL_COMP_pop_free(sk, freefunc) OPENSSL_sk_pop_free_ex(ossl_check_SSL_COMP_sk_type(sk), ossl_check_SSL_COMP_freefunc_type(freefunc), sk_SSL_COMP_freefunc_thunk)
...
#define sk_SSL_COMP_deep_copy(sk, copyfunc, freefunc) ((STACK_OF(SSL_COMP) *)OPENSSL_sk_deep_copy_ex(ossl_check_const_SSL_COMP_sk_type(sk), ossl_check_SSL_COMP_copyfunc_type(copyfunc), ossl_check_SSL_COMP_freefunc_type(freefunc), sk_SSL_COMP_copyfunc_thunk, sk_SSL_COMP_freefunc_thunk))
#define sk_SSL_COMP_set_cmp_func(sk, cmp) ((sk_SSL_COMP_compfunc)OPENSSL_sk_set_cmp_func_ex(ossl_check_SSL_COMP_sk_type(sk), ossl_check_SSL_COMP_compfunc_type(cmp), sk_SSL_COMP_compfunc_thunk))
