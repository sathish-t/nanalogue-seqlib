/*
 * WARNING: do not edit!
 * Generated by Makefile from ../../../vendor/openssl/include/openssl/x509_acert.h.in
 *
...
#define sk_OSSL_IETF_ATTR_SYNTAX_VALUE_new(cmp) ((STACK_OF(OSSL_IETF_ATTR_SYNTAX_VALUE) *)OPENSSL_sk_new_reserve_ex(ossl_check_OSSL_IETF_ATTR_SYNTAX_VALUE_compfunc_type(cmp), 0, sk_OSSL_IETF_ATTR_SYNTAX_VALUE_compfunc_thunk))
#define sk_OSSL_IETF_ATTR_SYNTAX_VALUE_new_null() ((STACK_OF(OSSL_IETF_ATTR_SYNTAX_VALUE) *)OPENSSL_sk_new_null())
#define sk_OSSL_IETF_ATTR_SYNTAX_VALUE_new_reserve(cmp, n) ((STACK_OF(OSSL_IETF_ATTR_SYNTAX_VALUE) *)OPENSSL_sk_new_reserve_ex(ossl_check_OSSL_IETF_ATTR_SYNTAX_VALUE_compfunc_type(cmp), (n), sk_OSSL_IETF_ATTR_SYNTAX_VALUE_compfunc_thunk))
...
#define sk_OSSL_IETF_ATTR_SYNTAX_VALUE_pop_free(sk, freefunc) OPENSSL_sk_pop_free_ex(ossl_check_OSSL_IETF_ATTR_SYNTAX_VALUE_sk_type(sk), ossl_check_OSSL_IETF_ATTR_SYNTAX_VALUE_freefunc_type(freefunc), sk_OSSL_IETF_ATTR_SYNTAX_VALUE_freefunc_thunk)
...
#define sk_OSSL_IETF_ATTR_SYNTAX_VALUE_deep_copy(sk, copyfunc, freefunc) ((STACK_OF(OSSL_IETF_ATTR_SYNTAX_VALUE) *)OPENSSL_sk_deep_copy_ex(ossl_check_const_OSSL_IETF_ATTR_SYNTAX_VALUE_sk_type(sk), ossl_check_OSSL_IETF_ATTR_SYNTAX_VALUE_copyfunc_type(copyfunc), ossl_check_OSSL_IETF_ATTR_SYNTAX_VALUE_freefunc_type(freefunc), sk_OSSL_IETF_ATTR_SYNTAX_VALUE_copyfunc_thunk, sk_OSSL_IETF_ATTR_SYNTAX_VALUE_freefunc_thunk))
#define sk_OSSL_IETF_ATTR_SYNTAX_VALUE_set_cmp_func(sk, cmp) ((sk_OSSL_IETF_ATTR_SYNTAX_VALUE_compfunc)OPENSSL_sk_set_cmp_func_ex(ossl_check_OSSL_IETF_ATTR_SYNTAX_VALUE_sk_type(sk), ossl_check_OSSL_IETF_ATTR_SYNTAX_VALUE_compfunc_type(cmp), sk_OSSL_IETF_ATTR_SYNTAX_VALUE_compfunc_thunk))
...
#define sk_OSSL_TARGET_new(cmp) ((STACK_OF(OSSL_TARGET) *)OPENSSL_sk_new_reserve_ex(ossl_check_OSSL_TARGET_compfunc_type(cmp), 0, sk_OSSL_TARGET_compfunc_thunk))
#define sk_OSSL_TARGET_new_null() ((STACK_OF(OSSL_TARGET) *)OPENSSL_sk_new_null())
#define sk_OSSL_TARGET_new_reserve(cmp, n) ((STACK_OF(OSSL_TARGET) *)OPENSSL_sk_new_reserve_ex(ossl_check_OSSL_TARGET_compfunc_type(cmp), (n), sk_OSSL_TARGET_compfunc_thunk))
...
#define sk_OSSL_TARGET_pop_free(sk, freefunc) OPENSSL_sk_pop_free_ex(ossl_check_OSSL_TARGET_sk_type(sk), ossl_check_OSSL_TARGET_freefunc_type(freefunc), sk_OSSL_TARGET_freefunc_thunk)
...
#define sk_OSSL_TARGET_deep_copy(sk, copyfunc, freefunc) ((STACK_OF(OSSL_TARGET) *)OPENSSL_sk_deep_copy_ex(ossl_check_const_OSSL_TARGET_sk_type(sk), ossl_check_OSSL_TARGET_copyfunc_type(copyfunc), ossl_check_OSSL_TARGET_freefunc_type(freefunc), sk_OSSL_TARGET_copyfunc_thunk, sk_OSSL_TARGET_freefunc_thunk))
#define sk_OSSL_TARGET_set_cmp_func(sk, cmp) ((sk_OSSL_TARGET_compfunc)OPENSSL_sk_set_cmp_func_ex(ossl_check_OSSL_TARGET_sk_type(sk), ossl_check_OSSL_TARGET_compfunc_type(cmp), sk_OSSL_TARGET_compfunc_thunk))
...
#define sk_OSSL_TARGETS_new(cmp) ((STACK_OF(OSSL_TARGETS) *)OPENSSL_sk_new_reserve_ex(ossl_check_OSSL_TARGETS_compfunc_type(cmp), 0, sk_OSSL_TARGETS_compfunc_thunk))
#define sk_OSSL_TARGETS_new_null() ((STACK_OF(OSSL_TARGETS) *)OPENSSL_sk_new_null())
#define sk_OSSL_TARGETS_new_reserve(cmp, n) ((STACK_OF(OSSL_TARGETS) *)OPENSSL_sk_new_reserve_ex(ossl_check_OSSL_TARGETS_compfunc_type(cmp), (n), sk_OSSL_TARGETS_compfunc_thunk))
...
#define sk_OSSL_TARGETS_pop_free(sk, freefunc) OPENSSL_sk_pop_free_ex(ossl_check_OSSL_TARGETS_sk_type(sk), ossl_check_OSSL_TARGETS_freefunc_type(freefunc), sk_OSSL_TARGETS_freefunc_thunk)
...
#define sk_OSSL_TARGETS_deep_copy(sk, copyfunc, freefunc) ((STACK_OF(OSSL_TARGETS) *)OPENSSL_sk_deep_copy_ex(ossl_check_const_OSSL_TARGETS_sk_type(sk), ossl_check_OSSL_TARGETS_copyfunc_type(copyfunc), ossl_check_OSSL_TARGETS_freefunc_type(freefunc), sk_OSSL_TARGETS_copyfunc_thunk, sk_OSSL_TARGETS_freefunc_thunk))
#define sk_OSSL_TARGETS_set_cmp_func(sk, cmp) ((sk_OSSL_TARGETS_compfunc)OPENSSL_sk_set_cmp_func_ex(ossl_check_OSSL_TARGETS_sk_type(sk), ossl_check_OSSL_TARGETS_compfunc_type(cmp), sk_OSSL_TARGETS_compfunc_thunk))
...
#define sk_OSSL_ISSUER_SERIAL_new(cmp) ((STACK_OF(OSSL_ISSUER_SERIAL) *)OPENSSL_sk_new_reserve_ex(ossl_check_OSSL_ISSUER_SERIAL_compfunc_type(cmp), 0, sk_OSSL_ISSUER_SERIAL_compfunc_thunk))
#define sk_OSSL_ISSUER_SERIAL_new_null() ((STACK_OF(OSSL_ISSUER_SERIAL) *)OPENSSL_sk_new_null())
#define sk_OSSL_ISSUER_SERIAL_new_reserve(cmp, n) ((STACK_OF(OSSL_ISSUER_SERIAL) *)OPENSSL_sk_new_reserve_ex(ossl_check_OSSL_ISSUER_SERIAL_compfunc_type(cmp), (n), sk_OSSL_ISSUER_SERIAL_compfunc_thunk))
...
#define sk_OSSL_ISSUER_SERIAL_pop_free(sk, freefunc) OPENSSL_sk_pop_free_ex(ossl_check_OSSL_ISSUER_SERIAL_sk_type(sk), ossl_check_OSSL_ISSUER_SERIAL_freefunc_type(freefunc), sk_OSSL_ISSUER_SERIAL_freefunc_thunk)
...
#define sk_OSSL_ISSUER_SERIAL_deep_copy(sk, copyfunc, freefunc) ((STACK_OF(OSSL_ISSUER_SERIAL) *)OPENSSL_sk_deep_copy_ex(ossl_check_const_OSSL_ISSUER_SERIAL_sk_type(sk), ossl_check_OSSL_ISSUER_SERIAL_copyfunc_type(copyfunc), ossl_check_OSSL_ISSUER_SERIAL_freefunc_type(freefunc), sk_OSSL_ISSUER_SERIAL_copyfunc_thunk, sk_OSSL_ISSUER_SERIAL_freefunc_thunk))
#define sk_OSSL_ISSUER_SERIAL_set_cmp_func(sk, cmp) ((sk_OSSL_ISSUER_SERIAL_compfunc)OPENSSL_sk_set_cmp_func_ex(ossl_check_OSSL_ISSUER_SERIAL_sk_type(sk), ossl_check_OSSL_ISSUER_SERIAL_compfunc_type(cmp), sk_OSSL_ISSUER_SERIAL_compfunc_thunk))
