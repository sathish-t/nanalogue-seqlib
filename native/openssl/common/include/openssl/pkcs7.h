...
#define sk_PKCS7_SIGNER_INFO_new(cmp) ((STACK_OF(PKCS7_SIGNER_INFO) *)OPENSSL_sk_new_reserve_ex(ossl_check_PKCS7_SIGNER_INFO_compfunc_type(cmp), 0, sk_PKCS7_SIGNER_INFO_compfunc_thunk))
#define sk_PKCS7_SIGNER_INFO_new_null() ((STACK_OF(PKCS7_SIGNER_INFO) *)OPENSSL_sk_new_null())
#define sk_PKCS7_SIGNER_INFO_new_reserve(cmp, n) ((STACK_OF(PKCS7_SIGNER_INFO) *)OPENSSL_sk_new_reserve_ex(ossl_check_PKCS7_SIGNER_INFO_compfunc_type(cmp), (n), sk_PKCS7_SIGNER_INFO_compfunc_thunk))
...
#define sk_PKCS7_SIGNER_INFO_pop_free(sk, freefunc) OPENSSL_sk_pop_free_ex(ossl_check_PKCS7_SIGNER_INFO_sk_type(sk), ossl_check_PKCS7_SIGNER_INFO_freefunc_type(freefunc), sk_PKCS7_SIGNER_INFO_freefunc_thunk)
...
#define sk_PKCS7_SIGNER_INFO_deep_copy(sk, copyfunc, freefunc) ((STACK_OF(PKCS7_SIGNER_INFO) *)OPENSSL_sk_deep_copy_ex(ossl_check_const_PKCS7_SIGNER_INFO_sk_type(sk), ossl_check_PKCS7_SIGNER_INFO_copyfunc_type(copyfunc), ossl_check_PKCS7_SIGNER_INFO_freefunc_type(freefunc), sk_PKCS7_SIGNER_INFO_copyfunc_thunk, sk_PKCS7_SIGNER_INFO_freefunc_thunk))
#define sk_PKCS7_SIGNER_INFO_set_cmp_func(sk, cmp) ((sk_PKCS7_SIGNER_INFO_compfunc)OPENSSL_sk_set_cmp_func_ex(ossl_check_PKCS7_SIGNER_INFO_sk_type(sk), ossl_check_PKCS7_SIGNER_INFO_compfunc_type(cmp), sk_PKCS7_SIGNER_INFO_compfunc_thunk))
...
#define sk_PKCS7_RECIP_INFO_new(cmp) ((STACK_OF(PKCS7_RECIP_INFO) *)OPENSSL_sk_new_reserve_ex(ossl_check_PKCS7_RECIP_INFO_compfunc_type(cmp), 0, sk_PKCS7_RECIP_INFO_compfunc_thunk))
#define sk_PKCS7_RECIP_INFO_new_null() ((STACK_OF(PKCS7_RECIP_INFO) *)OPENSSL_sk_new_null())
#define sk_PKCS7_RECIP_INFO_new_reserve(cmp, n) ((STACK_OF(PKCS7_RECIP_INFO) *)OPENSSL_sk_new_reserve_ex(ossl_check_PKCS7_RECIP_INFO_compfunc_type(cmp), (n), sk_PKCS7_RECIP_INFO_compfunc_thunk))
...
#define sk_PKCS7_RECIP_INFO_pop_free(sk, freefunc) OPENSSL_sk_pop_free_ex(ossl_check_PKCS7_RECIP_INFO_sk_type(sk), ossl_check_PKCS7_RECIP_INFO_freefunc_type(freefunc), sk_PKCS7_RECIP_INFO_freefunc_thunk)
...
#define sk_PKCS7_RECIP_INFO_deep_copy(sk, copyfunc, freefunc) ((STACK_OF(PKCS7_RECIP_INFO) *)OPENSSL_sk_deep_copy_ex(ossl_check_const_PKCS7_RECIP_INFO_sk_type(sk), ossl_check_PKCS7_RECIP_INFO_copyfunc_type(copyfunc), ossl_check_PKCS7_RECIP_INFO_freefunc_type(freefunc), sk_PKCS7_RECIP_INFO_copyfunc_thunk, sk_PKCS7_RECIP_INFO_freefunc_thunk))
#define sk_PKCS7_RECIP_INFO_set_cmp_func(sk, cmp) ((sk_PKCS7_RECIP_INFO_compfunc)OPENSSL_sk_set_cmp_func_ex(ossl_check_PKCS7_RECIP_INFO_sk_type(sk), ossl_check_PKCS7_RECIP_INFO_compfunc_type(cmp), sk_PKCS7_RECIP_INFO_compfunc_thunk))
...
#define sk_PKCS7_new(cmp) ((STACK_OF(PKCS7) *)OPENSSL_sk_new_reserve_ex(ossl_check_PKCS7_compfunc_type(cmp), 0, sk_PKCS7_compfunc_thunk))
#define sk_PKCS7_new_null() ((STACK_OF(PKCS7) *)OPENSSL_sk_new_null())
#define sk_PKCS7_new_reserve(cmp, n) ((STACK_OF(PKCS7) *)OPENSSL_sk_new_reserve_ex(ossl_check_PKCS7_compfunc_type(cmp), (n), sk_PKCS7_compfunc_thunk))
...
#define sk_PKCS7_pop_free(sk, freefunc) OPENSSL_sk_pop_free_ex(ossl_check_PKCS7_sk_type(sk), ossl_check_PKCS7_freefunc_type(freefunc), sk_PKCS7_freefunc_thunk)
...
#define sk_PKCS7_deep_copy(sk, copyfunc, freefunc) ((STACK_OF(PKCS7) *)OPENSSL_sk_deep_copy_ex(ossl_check_const_PKCS7_sk_type(sk), ossl_check_PKCS7_copyfunc_type(copyfunc), ossl_check_PKCS7_freefunc_type(freefunc), sk_PKCS7_copyfunc_thunk, sk_PKCS7_freefunc_thunk))
#define sk_PKCS7_set_cmp_func(sk, cmp) ((sk_PKCS7_compfunc)OPENSSL_sk_set_cmp_func_ex(ossl_check_PKCS7_sk_type(sk), ossl_check_PKCS7_compfunc_type(cmp), sk_PKCS7_compfunc_thunk))
