...
#define sk_UI_STRING_new(cmp) ((STACK_OF(UI_STRING) *)OPENSSL_sk_new_reserve_ex(ossl_check_UI_STRING_compfunc_type(cmp), 0, sk_UI_STRING_compfunc_thunk))
#define sk_UI_STRING_new_null() ((STACK_OF(UI_STRING) *)OPENSSL_sk_new_null())
#define sk_UI_STRING_new_reserve(cmp, n) ((STACK_OF(UI_STRING) *)OPENSSL_sk_new_reserve_ex(ossl_check_UI_STRING_compfunc_type(cmp), (n), sk_UI_STRING_compfunc_thunk))
...
#define sk_UI_STRING_pop_free(sk, freefunc) OPENSSL_sk_pop_free_ex(ossl_check_UI_STRING_sk_type(sk), ossl_check_UI_STRING_freefunc_type(freefunc), sk_UI_STRING_freefunc_thunk)
...
#define sk_UI_STRING_deep_copy(sk, copyfunc, freefunc) ((STACK_OF(UI_STRING) *)OPENSSL_sk_deep_copy_ex(ossl_check_const_UI_STRING_sk_type(sk), ossl_check_UI_STRING_copyfunc_type(copyfunc), ossl_check_UI_STRING_freefunc_type(freefunc), sk_UI_STRING_copyfunc_thunk, sk_UI_STRING_freefunc_thunk))
#define sk_UI_STRING_set_cmp_func(sk, cmp) ((sk_UI_STRING_compfunc)OPENSSL_sk_set_cmp_func_ex(ossl_check_UI_STRING_sk_type(sk), ossl_check_UI_STRING_compfunc_type(cmp), sk_UI_STRING_compfunc_thunk))
