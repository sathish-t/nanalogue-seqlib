...
#define sk_OCSP_CERTID_new(cmp) ((STACK_OF(OCSP_CERTID) *)OPENSSL_sk_new_reserve_ex(ossl_check_OCSP_CERTID_compfunc_type(cmp), 0, sk_OCSP_CERTID_compfunc_thunk))
#define sk_OCSP_CERTID_new_null() ((STACK_OF(OCSP_CERTID) *)OPENSSL_sk_new_null())
#define sk_OCSP_CERTID_new_reserve(cmp, n) ((STACK_OF(OCSP_CERTID) *)OPENSSL_sk_new_reserve_ex(ossl_check_OCSP_CERTID_compfunc_type(cmp), (n), sk_OCSP_CERTID_compfunc_thunk))
...
#define sk_OCSP_CERTID_pop_free(sk, freefunc) OPENSSL_sk_pop_free_ex(ossl_check_OCSP_CERTID_sk_type(sk), ossl_check_OCSP_CERTID_freefunc_type(freefunc), sk_OCSP_CERTID_freefunc_thunk)
...
#define sk_OCSP_CERTID_deep_copy(sk, copyfunc, freefunc) ((STACK_OF(OCSP_CERTID) *)OPENSSL_sk_deep_copy_ex(ossl_check_const_OCSP_CERTID_sk_type(sk), ossl_check_OCSP_CERTID_copyfunc_type(copyfunc), ossl_check_OCSP_CERTID_freefunc_type(freefunc), sk_OCSP_CERTID_copyfunc_thunk, sk_OCSP_CERTID_freefunc_thunk))
#define sk_OCSP_CERTID_set_cmp_func(sk, cmp) ((sk_OCSP_CERTID_compfunc)OPENSSL_sk_set_cmp_func_ex(ossl_check_OCSP_CERTID_sk_type(sk), ossl_check_OCSP_CERTID_compfunc_type(cmp), sk_OCSP_CERTID_compfunc_thunk))
...
#define sk_OCSP_ONEREQ_new(cmp) ((STACK_OF(OCSP_ONEREQ) *)OPENSSL_sk_new_reserve_ex(ossl_check_OCSP_ONEREQ_compfunc_type(cmp), 0, sk_OCSP_ONEREQ_compfunc_thunk))
#define sk_OCSP_ONEREQ_new_null() ((STACK_OF(OCSP_ONEREQ) *)OPENSSL_sk_new_null())
#define sk_OCSP_ONEREQ_new_reserve(cmp, n) ((STACK_OF(OCSP_ONEREQ) *)OPENSSL_sk_new_reserve_ex(ossl_check_OCSP_ONEREQ_compfunc_type(cmp), (n), sk_OCSP_ONEREQ_compfunc_thunk))
...
#define sk_OCSP_ONEREQ_pop_free(sk, freefunc) OPENSSL_sk_pop_free_ex(ossl_check_OCSP_ONEREQ_sk_type(sk), ossl_check_OCSP_ONEREQ_freefunc_type(freefunc), sk_OCSP_ONEREQ_freefunc_thunk)
...
#define sk_OCSP_ONEREQ_deep_copy(sk, copyfunc, freefunc) ((STACK_OF(OCSP_ONEREQ) *)OPENSSL_sk_deep_copy_ex(ossl_check_const_OCSP_ONEREQ_sk_type(sk), ossl_check_OCSP_ONEREQ_copyfunc_type(copyfunc), ossl_check_OCSP_ONEREQ_freefunc_type(freefunc), sk_OCSP_ONEREQ_copyfunc_thunk, sk_OCSP_ONEREQ_freefunc_thunk))
#define sk_OCSP_ONEREQ_set_cmp_func(sk, cmp) ((sk_OCSP_ONEREQ_compfunc)OPENSSL_sk_set_cmp_func_ex(ossl_check_OCSP_ONEREQ_sk_type(sk), ossl_check_OCSP_ONEREQ_compfunc_type(cmp), sk_OCSP_ONEREQ_compfunc_thunk))
...
#define sk_OCSP_RESPID_new(cmp) ((STACK_OF(OCSP_RESPID) *)OPENSSL_sk_new_reserve_ex(ossl_check_OCSP_RESPID_compfunc_type(cmp), 0, sk_OCSP_RESPID_compfunc_thunk))
#define sk_OCSP_RESPID_new_null() ((STACK_OF(OCSP_RESPID) *)OPENSSL_sk_new_null())
#define sk_OCSP_RESPID_new_reserve(cmp, n) ((STACK_OF(OCSP_RESPID) *)OPENSSL_sk_new_reserve_ex(ossl_check_OCSP_RESPID_compfunc_type(cmp), (n), sk_OCSP_RESPID_compfunc_thunk))
...
#define sk_OCSP_RESPID_pop_free(sk, freefunc) OPENSSL_sk_pop_free_ex(ossl_check_OCSP_RESPID_sk_type(sk), ossl_check_OCSP_RESPID_freefunc_type(freefunc), sk_OCSP_RESPID_freefunc_thunk)
...
#define sk_OCSP_RESPID_deep_copy(sk, copyfunc, freefunc) ((STACK_OF(OCSP_RESPID) *)OPENSSL_sk_deep_copy_ex(ossl_check_const_OCSP_RESPID_sk_type(sk), ossl_check_OCSP_RESPID_copyfunc_type(copyfunc), ossl_check_OCSP_RESPID_freefunc_type(freefunc), sk_OCSP_RESPID_copyfunc_thunk, sk_OCSP_RESPID_freefunc_thunk))
#define sk_OCSP_RESPID_set_cmp_func(sk, cmp) ((sk_OCSP_RESPID_compfunc)OPENSSL_sk_set_cmp_func_ex(ossl_check_OCSP_RESPID_sk_type(sk), ossl_check_OCSP_RESPID_compfunc_type(cmp), sk_OCSP_RESPID_compfunc_thunk))
...
#define sk_OCSP_SINGLERESP_new(cmp) ((STACK_OF(OCSP_SINGLERESP) *)OPENSSL_sk_new_reserve_ex(ossl_check_OCSP_SINGLERESP_compfunc_type(cmp), 0, sk_OCSP_SINGLERESP_compfunc_thunk))
#define sk_OCSP_SINGLERESP_new_null() ((STACK_OF(OCSP_SINGLERESP) *)OPENSSL_sk_new_null())
#define sk_OCSP_SINGLERESP_new_reserve(cmp, n) ((STACK_OF(OCSP_SINGLERESP) *)OPENSSL_sk_new_reserve_ex(ossl_check_OCSP_SINGLERESP_compfunc_type(cmp), (n), sk_OCSP_SINGLERESP_compfunc_thunk))
...
#define sk_OCSP_SINGLERESP_pop_free(sk, freefunc) OPENSSL_sk_pop_free_ex(ossl_check_OCSP_SINGLERESP_sk_type(sk), ossl_check_OCSP_SINGLERESP_freefunc_type(freefunc), sk_OCSP_SINGLERESP_freefunc_thunk)
...
#define sk_OCSP_SINGLERESP_deep_copy(sk, copyfunc, freefunc) ((STACK_OF(OCSP_SINGLERESP) *)OPENSSL_sk_deep_copy_ex(ossl_check_const_OCSP_SINGLERESP_sk_type(sk), ossl_check_OCSP_SINGLERESP_copyfunc_type(copyfunc), ossl_check_OCSP_SINGLERESP_freefunc_type(freefunc), sk_OCSP_SINGLERESP_copyfunc_thunk, sk_OCSP_SINGLERESP_freefunc_thunk))
#define sk_OCSP_SINGLERESP_set_cmp_func(sk, cmp) ((sk_OCSP_SINGLERESP_compfunc)OPENSSL_sk_set_cmp_func_ex(ossl_check_OCSP_SINGLERESP_sk_type(sk), ossl_check_OCSP_SINGLERESP_compfunc_type(cmp), sk_OCSP_SINGLERESP_compfunc_thunk))
