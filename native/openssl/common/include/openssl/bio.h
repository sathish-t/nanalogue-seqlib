...
#define sk_BIO_new(cmp) ((STACK_OF(BIO) *)OPENSSL_sk_new_reserve_ex(ossl_check_BIO_compfunc_type(cmp), 0, sk_BIO_compfunc_thunk))
#define sk_BIO_new_null() ((STACK_OF(BIO) *)OPENSSL_sk_new_null())
#define sk_BIO_new_reserve(cmp, n) ((STACK_OF(BIO) *)OPENSSL_sk_new_reserve_ex(ossl_check_BIO_compfunc_type(cmp), (n), sk_BIO_compfunc_thunk))
...
#define sk_BIO_pop_free(sk, freefunc) OPENSSL_sk_pop_free_ex(ossl_check_BIO_sk_type(sk), ossl_check_BIO_freefunc_type(freefunc), sk_BIO_freefunc_thunk)
...
#define sk_BIO_deep_copy(sk, copyfunc, freefunc) ((STACK_OF(BIO) *)OPENSSL_sk_deep_copy_ex(ossl_check_const_BIO_sk_type(sk), ossl_check_BIO_copyfunc_type(copyfunc), ossl_check_BIO_freefunc_type(freefunc), sk_BIO_copyfunc_thunk, sk_BIO_freefunc_thunk))
#define sk_BIO_set_cmp_func(sk, cmp) ((sk_BIO_compfunc)OPENSSL_sk_set_cmp_func_ex(ossl_check_BIO_sk_type(sk), ossl_check_BIO_compfunc_type(cmp), sk_BIO_compfunc_thunk))
