...
#define sk_SRP_gN_cache_new(cmp) ((STACK_OF(SRP_gN_cache) *)OPENSSL_sk_new_reserve_ex(ossl_check_SRP_gN_cache_compfunc_type(cmp), 0, sk_SRP_gN_cache_compfunc_thunk))
#define sk_SRP_gN_cache_new_null() ((STACK_OF(SRP_gN_cache) *)OPENSSL_sk_new_null())
#define sk_SRP_gN_cache_new_reserve(cmp, n) ((STACK_OF(SRP_gN_cache) *)OPENSSL_sk_new_reserve_ex(ossl_check_SRP_gN_cache_compfunc_type(cmp), (n), sk_SRP_gN_cache_compfunc_thunk))
...
#define sk_SRP_gN_cache_pop_free(sk, freefunc) OPENSSL_sk_pop_free_ex(ossl_check_SRP_gN_cache_sk_type(sk), ossl_check_SRP_gN_cache_freefunc_type(freefunc), sk_SRP_gN_cache_freefunc_thunk)
...
#define sk_SRP_gN_cache_deep_copy(sk, copyfunc, freefunc) ((STACK_OF(SRP_gN_cache) *)OPENSSL_sk_deep_copy_ex(ossl_check_const_SRP_gN_cache_sk_type(sk), ossl_check_SRP_gN_cache_copyfunc_type(copyfunc), ossl_check_SRP_gN_cache_freefunc_type(freefunc), sk_SRP_gN_cache_copyfunc_thunk, sk_SRP_gN_cache_freefunc_thunk))
#define sk_SRP_gN_cache_set_cmp_func(sk, cmp) ((sk_SRP_gN_cache_compfunc)OPENSSL_sk_set_cmp_func_ex(ossl_check_SRP_gN_cache_sk_type(sk), ossl_check_SRP_gN_cache_compfunc_type(cmp), sk_SRP_gN_cache_compfunc_thunk))
...
#define sk_SRP_user_pwd_new(cmp) ((STACK_OF(SRP_user_pwd) *)OPENSSL_sk_new_reserve_ex(ossl_check_SRP_user_pwd_compfunc_type(cmp), 0, sk_SRP_user_pwd_compfunc_thunk))
#define sk_SRP_user_pwd_new_null() ((STACK_OF(SRP_user_pwd) *)OPENSSL_sk_new_null())
#define sk_SRP_user_pwd_new_reserve(cmp, n) ((STACK_OF(SRP_user_pwd) *)OPENSSL_sk_new_reserve_ex(ossl_check_SRP_user_pwd_compfunc_type(cmp), (n), sk_SRP_user_pwd_compfunc_thunk))
...
#define sk_SRP_user_pwd_pop_free(sk, freefunc) OPENSSL_sk_pop_free_ex(ossl_check_SRP_user_pwd_sk_type(sk), ossl_check_SRP_user_pwd_freefunc_type(freefunc), sk_SRP_user_pwd_freefunc_thunk)
...
#define sk_SRP_user_pwd_deep_copy(sk, copyfunc, freefunc) ((STACK_OF(SRP_user_pwd) *)OPENSSL_sk_deep_copy_ex(ossl_check_const_SRP_user_pwd_sk_type(sk), ossl_check_SRP_user_pwd_copyfunc_type(copyfunc), ossl_check_SRP_user_pwd_freefunc_type(freefunc), sk_SRP_user_pwd_copyfunc_thunk, sk_SRP_user_pwd_freefunc_thunk))
#define sk_SRP_user_pwd_set_cmp_func(sk, cmp) ((sk_SRP_user_pwd_compfunc)OPENSSL_sk_set_cmp_func_ex(ossl_check_SRP_user_pwd_sk_type(sk), ossl_check_SRP_user_pwd_compfunc_type(cmp), sk_SRP_user_pwd_compfunc_thunk))
...
#define sk_SRP_gN_new(cmp) ((STACK_OF(SRP_gN) *)OPENSSL_sk_new_reserve_ex(ossl_check_SRP_gN_compfunc_type(cmp), 0, sk_SRP_gN_compfunc_thunk))
#define sk_SRP_gN_new_null() ((STACK_OF(SRP_gN) *)OPENSSL_sk_new_null())
#define sk_SRP_gN_new_reserve(cmp, n) ((STACK_OF(SRP_gN) *)OPENSSL_sk_new_reserve_ex(ossl_check_SRP_gN_compfunc_type(cmp), (n), sk_SRP_gN_compfunc_thunk))
...
#define sk_SRP_gN_pop_free(sk, freefunc) OPENSSL_sk_pop_free_ex(ossl_check_SRP_gN_sk_type(sk), ossl_check_SRP_gN_freefunc_type(freefunc), sk_SRP_gN_freefunc_thunk)
...
#define sk_SRP_gN_deep_copy(sk, copyfunc, freefunc) ((STACK_OF(SRP_gN) *)OPENSSL_sk_deep_copy_ex(ossl_check_const_SRP_gN_sk_type(sk), ossl_check_SRP_gN_copyfunc_type(copyfunc), ossl_check_SRP_gN_freefunc_type(freefunc), sk_SRP_gN_copyfunc_thunk, sk_SRP_gN_freefunc_thunk))
#define sk_SRP_gN_set_cmp_func(sk, cmp) ((sk_SRP_gN_compfunc)OPENSSL_sk_set_cmp_func_ex(ossl_check_SRP_gN_sk_type(sk), ossl_check_SRP_gN_compfunc_type(cmp), sk_SRP_gN_compfunc_thunk))
