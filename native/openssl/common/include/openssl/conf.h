...
#define sk_CONF_VALUE_new(cmp) ((STACK_OF(CONF_VALUE) *)OPENSSL_sk_new_reserve_ex(ossl_check_CONF_VALUE_compfunc_type(cmp), 0, sk_CONF_VALUE_compfunc_thunk))
#define sk_CONF_VALUE_new_null() ((STACK_OF(CONF_VALUE) *)OPENSSL_sk_new_null())
#define sk_CONF_VALUE_new_reserve(cmp, n) ((STACK_OF(CONF_VALUE) *)OPENSSL_sk_new_reserve_ex(ossl_check_CONF_VALUE_compfunc_type(cmp), (n), sk_CONF_VALUE_compfunc_thunk))
...
#define sk_CONF_VALUE_pop_free(sk, freefunc) OPENSSL_sk_pop_free_ex(ossl_check_CONF_VALUE_sk_type(sk), ossl_check_CONF_VALUE_freefunc_type(freefunc), sk_CONF_VALUE_freefunc_thunk)
...
#define sk_CONF_VALUE_deep_copy(sk, copyfunc, freefunc) ((STACK_OF(CONF_VALUE) *)OPENSSL_sk_deep_copy_ex(ossl_check_const_CONF_VALUE_sk_type(sk), ossl_check_CONF_VALUE_copyfunc_type(copyfunc), ossl_check_CONF_VALUE_freefunc_type(freefunc), sk_CONF_VALUE_copyfunc_thunk, sk_CONF_VALUE_freefunc_thunk))
#define sk_CONF_VALUE_set_cmp_func(sk, cmp) ((sk_CONF_VALUE_compfunc)OPENSSL_sk_set_cmp_func_ex(ossl_check_CONF_VALUE_sk_type(sk), ossl_check_CONF_VALUE_compfunc_type(cmp), sk_CONF_VALUE_compfunc_thunk))
