...
#define sk_X509_LOOKUP_new(cmp) ((STACK_OF(X509_LOOKUP) *)OPENSSL_sk_new_reserve_ex(ossl_check_X509_LOOKUP_compfunc_type(cmp), 0, sk_X509_LOOKUP_compfunc_thunk))
#define sk_X509_LOOKUP_new_null() ((STACK_OF(X509_LOOKUP) *)OPENSSL_sk_new_null())
#define sk_X509_LOOKUP_new_reserve(cmp, n) ((STACK_OF(X509_LOOKUP) *)OPENSSL_sk_new_reserve_ex(ossl_check_X509_LOOKUP_compfunc_type(cmp), (n), sk_X509_LOOKUP_compfunc_thunk))
...
#define sk_X509_LOOKUP_pop_free(sk, freefunc) OPENSSL_sk_pop_free_ex(ossl_check_X509_LOOKUP_sk_type(sk), ossl_check_X509_LOOKUP_freefunc_type(freefunc), sk_X509_LOOKUP_freefunc_thunk)
...
#define sk_X509_LOOKUP_deep_copy(sk, copyfunc, freefunc) ((STACK_OF(X509_LOOKUP) *)OPENSSL_sk_deep_copy_ex(ossl_check_const_X509_LOOKUP_sk_type(sk), ossl_check_X509_LOOKUP_copyfunc_type(copyfunc), ossl_check_X509_LOOKUP_freefunc_type(freefunc), sk_X509_LOOKUP_copyfunc_thunk, sk_X509_LOOKUP_freefunc_thunk))
#define sk_X509_LOOKUP_set_cmp_func(sk, cmp) ((sk_X509_LOOKUP_compfunc)OPENSSL_sk_set_cmp_func_ex(ossl_check_X509_LOOKUP_sk_type(sk), ossl_check_X509_LOOKUP_compfunc_type(cmp), sk_X509_LOOKUP_compfunc_thunk))
...
#define sk_X509_OBJECT_new(cmp) ((STACK_OF(X509_OBJECT) *)OPENSSL_sk_new_reserve_ex(ossl_check_X509_OBJECT_compfunc_type(cmp), 0, sk_X509_OBJECT_compfunc_thunk))
#define sk_X509_OBJECT_new_null() ((STACK_OF(X509_OBJECT) *)OPENSSL_sk_new_null())
#define sk_X509_OBJECT_new_reserve(cmp, n) ((STACK_OF(X509_OBJECT) *)OPENSSL_sk_new_reserve_ex(ossl_check_X509_OBJECT_compfunc_type(cmp), (n), sk_X509_OBJECT_compfunc_thunk))
...
#define sk_X509_OBJECT_pop_free(sk, freefunc) OPENSSL_sk_pop_free_ex(ossl_check_X509_OBJECT_sk_type(sk), ossl_check_X509_OBJECT_freefunc_type(freefunc), sk_X509_OBJECT_freefunc_thunk)
...
#define sk_X509_OBJECT_deep_copy(sk, copyfunc, freefunc) ((STACK_OF(X509_OBJECT) *)OPENSSL_sk_deep_copy_ex(ossl_check_const_X509_OBJECT_sk_type(sk), ossl_check_X509_OBJECT_copyfunc_type(copyfunc), ossl_check_X509_OBJECT_freefunc_type(freefunc), sk_X509_OBJECT_copyfunc_thunk, sk_X509_OBJECT_freefunc_thunk))
#define sk_X509_OBJECT_set_cmp_func(sk, cmp) ((sk_X509_OBJECT_compfunc)OPENSSL_sk_set_cmp_func_ex(ossl_check_X509_OBJECT_sk_type(sk), ossl_check_X509_OBJECT_compfunc_type(cmp), sk_X509_OBJECT_compfunc_thunk))
...
#define sk_X509_VERIFY_PARAM_new(cmp) ((STACK_OF(X509_VERIFY_PARAM) *)OPENSSL_sk_new_reserve_ex(ossl_check_X509_VERIFY_PARAM_compfunc_type(cmp), 0, sk_X509_VERIFY_PARAM_compfunc_thunk))
#define sk_X509_VERIFY_PARAM_new_null() ((STACK_OF(X509_VERIFY_PARAM) *)OPENSSL_sk_new_null())
#define sk_X509_VERIFY_PARAM_new_reserve(cmp, n) ((STACK_OF(X509_VERIFY_PARAM) *)OPENSSL_sk_new_reserve_ex(ossl_check_X509_VERIFY_PARAM_compfunc_type(cmp), (n), sk_X509_VERIFY_PARAM_compfunc_thunk))
...
#define sk_X509_VERIFY_PARAM_pop_free(sk, freefunc) OPENSSL_sk_pop_free_ex(ossl_check_X509_VERIFY_PARAM_sk_type(sk), ossl_check_X509_VERIFY_PARAM_freefunc_type(freefunc), sk_X509_VERIFY_PARAM_freefunc_thunk)
...
#define sk_X509_VERIFY_PARAM_deep_copy(sk, copyfunc, freefunc) ((STACK_OF(X509_VERIFY_PARAM) *)OPENSSL_sk_deep_copy_ex(ossl_check_const_X509_VERIFY_PARAM_sk_type(sk), ossl_check_X509_VERIFY_PARAM_copyfunc_type(copyfunc), ossl_check_X509_VERIFY_PARAM_freefunc_type(freefunc), sk_X509_VERIFY_PARAM_copyfunc_thunk, sk_X509_VERIFY_PARAM_freefunc_thunk))
#define sk_X509_VERIFY_PARAM_set_cmp_func(sk, cmp) ((sk_X509_VERIFY_PARAM_compfunc)OPENSSL_sk_set_cmp_func_ex(ossl_check_X509_VERIFY_PARAM_sk_type(sk), ossl_check_X509_VERIFY_PARAM_compfunc_type(cmp), sk_X509_VERIFY_PARAM_compfunc_thunk))
...
#define sk_X509_TRUST_new(cmp) ((STACK_OF(X509_TRUST) *)OPENSSL_sk_new_reserve_ex(ossl_check_X509_TRUST_compfunc_type(cmp), 0, sk_X509_TRUST_compfunc_thunk))
#define sk_X509_TRUST_new_null() ((STACK_OF(X509_TRUST) *)OPENSSL_sk_new_null())
#define sk_X509_TRUST_new_reserve(cmp, n) ((STACK_OF(X509_TRUST) *)OPENSSL_sk_new_reserve_ex(ossl_check_X509_TRUST_compfunc_type(cmp), (n), sk_X509_TRUST_compfunc_thunk))
...
#define sk_X509_TRUST_pop_free(sk, freefunc) OPENSSL_sk_pop_free_ex(ossl_check_X509_TRUST_sk_type(sk), ossl_check_X509_TRUST_freefunc_type(freefunc), sk_X509_TRUST_freefunc_thunk)
...
#define sk_X509_TRUST_deep_copy(sk, copyfunc, freefunc) ((STACK_OF(X509_TRUST) *)OPENSSL_sk_deep_copy_ex(ossl_check_const_X509_TRUST_sk_type(sk), ossl_check_X509_TRUST_copyfunc_type(copyfunc), ossl_check_X509_TRUST_freefunc_type(freefunc), sk_X509_TRUST_copyfunc_thunk, sk_X509_TRUST_freefunc_thunk))
#define sk_X509_TRUST_set_cmp_func(sk, cmp) ((sk_X509_TRUST_compfunc)OPENSSL_sk_set_cmp_func_ex(ossl_check_X509_TRUST_sk_type(sk), ossl_check_X509_TRUST_compfunc_type(cmp), sk_X509_TRUST_compfunc_thunk))
