...
#define sk_SRTP_PROTECTION_PROFILE_new(cmp) ((STACK_OF(SRTP_PROTECTION_PROFILE) *)OPENSSL_sk_new_reserve_ex(ossl_check_SRTP_PROTECTION_PROFILE_compfunc_type(cmp), 0, sk_SRTP_PROTECTION_PROFILE_compfunc_thunk))
#define sk_SRTP_PROTECTION_PROFILE_new_null() ((STACK_OF(SRTP_PROTECTION_PROFILE) *)OPENSSL_sk_new_null())
#define sk_SRTP_PROTECTION_PROFILE_new_reserve(cmp, n) ((STACK_OF(SRTP_PROTECTION_PROFILE) *)OPENSSL_sk_new_reserve_ex(ossl_check_SRTP_PROTECTION_PROFILE_compfunc_type(cmp), (n), sk_SRTP_PROTECTION_PROFILE_compfunc_thunk))
...
#define sk_SRTP_PROTECTION_PROFILE_pop_free(sk, freefunc) OPENSSL_sk_pop_free_ex(ossl_check_SRTP_PROTECTION_PROFILE_sk_type(sk), ossl_check_SRTP_PROTECTION_PROFILE_freefunc_type(freefunc), sk_SRTP_PROTECTION_PROFILE_freefunc_thunk)
...
#define sk_SRTP_PROTECTION_PROFILE_deep_copy(sk, copyfunc, freefunc) ((STACK_OF(SRTP_PROTECTION_PROFILE) *)OPENSSL_sk_deep_copy_ex(ossl_check_const_SRTP_PROTECTION_PROFILE_sk_type(sk), ossl_check_SRTP_PROTECTION_PROFILE_copyfunc_type(copyfunc), ossl_check_SRTP_PROTECTION_PROFILE_freefunc_type(freefunc), sk_SRTP_PROTECTION_PROFILE_copyfunc_thunk, sk_SRTP_PROTECTION_PROFILE_freefunc_thunk))
#define sk_SRTP_PROTECTION_PROFILE_set_cmp_func(sk, cmp) ((sk_SRTP_PROTECTION_PROFILE_compfunc)OPENSSL_sk_set_cmp_func_ex(ossl_check_SRTP_PROTECTION_PROFILE_sk_type(sk), ossl_check_SRTP_PROTECTION_PROFILE_compfunc_type(cmp), sk_SRTP_PROTECTION_PROFILE_compfunc_thunk))
...
#define sk_SSL_CIPHER_new(cmp) ((STACK_OF(SSL_CIPHER) *)OPENSSL_sk_new_reserve_ex(ossl_check_SSL_CIPHER_compfunc_type(cmp), 0, sk_SSL_CIPHER_compfunc_thunk))
#define sk_SSL_CIPHER_new_null() ((STACK_OF(SSL_CIPHER) *)OPENSSL_sk_new_null())
#define sk_SSL_CIPHER_new_reserve(cmp, n) ((STACK_OF(SSL_CIPHER) *)OPENSSL_sk_new_reserve_ex(ossl_check_SSL_CIPHER_compfunc_type(cmp), (n), sk_SSL_CIPHER_compfunc_thunk))
...
#define sk_SSL_CIPHER_pop_free(sk, freefunc) OPENSSL_sk_pop_free_ex(ossl_check_SSL_CIPHER_sk_type(sk), ossl_check_SSL_CIPHER_freefunc_type(freefunc), sk_SSL_CIPHER_freefunc_thunk)
...
#define sk_SSL_CIPHER_deep_copy(sk, copyfunc, freefunc) ((STACK_OF(SSL_CIPHER) *)OPENSSL_sk_deep_copy_ex(ossl_check_const_SSL_CIPHER_sk_type(sk), ossl_check_SSL_CIPHER_copyfunc_type(copyfunc), ossl_check_SSL_CIPHER_freefunc_type(freefunc), sk_SSL_CIPHER_copyfunc_thunk, sk_SSL_CIPHER_freefunc_thunk))
#define sk_SSL_CIPHER_set_cmp_func(sk, cmp) ((sk_SSL_CIPHER_compfunc)OPENSSL_sk_set_cmp_func_ex(ossl_check_SSL_CIPHER_sk_type(sk), ossl_check_SSL_CIPHER_compfunc_type(cmp), sk_SSL_CIPHER_compfunc_thunk))
