...
#define sk_${nametype}_new(cmp) ((STACK_OF(${nametype}) *)OPENSSL_sk_new_reserve_ex(ossl_check_${nametype}_compfunc_type(cmp), 0, sk_${nametype}_compfunc_thunk))
#define sk_${nametype}_new_null() ((STACK_OF(${nametype}) *)OPENSSL_sk_new_null())
#define sk_${nametype}_new_reserve(cmp, n) ((STACK_OF(${nametype}) *)OPENSSL_sk_new_reserve_ex(ossl_check_${nametype}_compfunc_type(cmp), (n), sk_${nametype}_compfunc_thunk))
...
#define sk_${nametype}_pop_free(sk, freefunc) OPENSSL_sk_pop_free_ex(ossl_check_${nametype}_sk_type(sk), ossl_check_${nametype}_freefunc_type(freefunc), sk_${nametype}_freefunc_thunk)
...
#define sk_${nametype}_deep_copy(sk, copyfunc, freefunc) ((STACK_OF(${nametype}) *)OPENSSL_sk_deep_copy_ex(ossl_check_const_${nametype}_sk_type(sk), ossl_check_${nametype}_copyfunc_type(copyfunc), ossl_check_${nametype}_freefunc_type(freefunc), sk_${nametype}_copyfunc_thunk, sk_${nametype}_freefunc_thunk))
#define sk_${nametype}_set_cmp_func(sk, cmp) ((sk_${nametype}_compfunc)OPENSSL_sk_set_cmp_func_ex(ossl_check_${nametype}_sk_type(sk), ossl_check_${nametype}_compfunc_type(cmp), sk_${nametype}_compfunc_thunk))
END_MACROS
